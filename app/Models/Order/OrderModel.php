...
class OrderModel extends Model
{
    public function getAllData()
    {
    	...
    	->select('tbl_orders.status as status_order','tbl_orders.id as id_order','tbl_orders.total','tbl_orders.created_at','tbl_orders.updated_at','tbl_shippings.lastname','tbl_shippings.middlename','tbl_shippings.firstname','tbl_shippings.id as shipping_id')
