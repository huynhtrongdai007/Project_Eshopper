        ...
        <tr>
         ...
         <td>
          ...
          @else
           ...
           <input type="checkbox" class="post_status_on" id="{{$items->id}}" data-toggle="toggle" data-onstyle="success" data-offstyle="danger">
          @endif
          </td>
         <td>{{$items->created_at}}</td>
         <td>{{$items->updated_at}}</td>
         <td><a href="{{ route('admin.post.edit',['id'=>$items->id]) }}">Edit</a> | <a href="{{ route('admin.post.destroy',['id'=>$items->id]) }}">Delete</a></td>
      </tr>
